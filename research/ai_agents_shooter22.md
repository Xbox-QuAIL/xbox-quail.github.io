## Open-world Game Exploration and Testing Using AI Agents

![]({{ site.url }}{{ site.baseurl }}/images/respic/aiagent_demo22/banner.png){: style="width: 600px; float: center;margin-right: 30px; border: 10px"}
